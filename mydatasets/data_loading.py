...
from mydatasets.imagelist_dataset import ImageList, FGVCAircraft
from mydatasets.imagenet_subsets import create_imagenet_subset
from mydatasets.corruptions_datasets import create_cifarc_dataset, create_imagenetc_dataset
from mydatasets.imagenet_d_utils import create_symlinks_and_get_imagenet_visda_mapping
from mydatasets.imagenet_dict import map_dict
...
def sort_by_dirichlet(delta_dirichlet: float, samples: list):
    ...
    # External reference implementation link redacted for anonymous submission
    min_size = -1
    min_size_thresh = 10
